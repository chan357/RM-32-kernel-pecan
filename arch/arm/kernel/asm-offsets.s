...
@ arch/arm/kernel/asm-offsets.c -mlittle-endian -mtune=arm1136jf-s
@ -march=armv6j -mfpu=vfp -marm -march=armv6zk -mtune=arm1176jzf-s
@ -mfpu=vfp -mfloat-abi=softfp -marm -mabi=aapcs-linux -mno-thumb-interwork
@ -march=armv6k -mtune=arm1136j-s -mfpu=vfp -mtune=arm1136jf-s
@ -mtune=arm1136jf-s -march=armv6j -mfpu=vfp -mfpu=vfp -auxbase-strip
...
@ -funsafe-loop-optimizations -funroll-loops -funwind-tables
@ -fno-stack-protector -fomit-frame-pointer -fno-strict-overflow
@ -fno-dwarf2-cfi-asm -fconserve-stack -ffast-math -fverbose-asm
